...
export default function Contacto() {
  return (
    <div className="container">
        <h2 className="my-5 text-center fs-1">Vení a visitarnos</h2>
        <div className="row my-5">
            <div className="col-12 col-md-6 text-center d-flex flex-column justify-content-center">
                <div>
                    <h3>Horario de atención</h3>
                    <p>Lunes a Viernes 00 a 00hs</p>
                    <p>Sábados de 00 a 01hs</p>
                </div>

                <div className="mt-4">
                    <h3>Dirección</h3>
                    <p>Nombre de calle 5544</p>
                    <p>Gualeguaychú, Entre Ríos</p>
                </div>
            </div>
            <div className="col-12 col-md-6 text-center mt-5 mt-md-0">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3345.3761093595913!2d-58.53567398255615!3d-33.0202203!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95baa8187cde399f%3A0x4d81055cdf7bccae!2sForrajer%C3%ADa%20Esmoris!5e0!3m2!1ses-419!2smx!4v1681330987605!5m2!1ses-419!2smx" className="tamano" style={{border:0}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>

        <div className="row my-5 text-center">
            <div className="col-12 col-md-6">
                <h4 className="fs-1">Contactanos</h4>
            ...
            <div className="col-12 col-md-6 mt-5 mt-md-0">
                ...
                <div className="d-flex gap-3 justify-content-center align-items-center mt-4">
                    ...
                    <p className="m-0">Facebook ejemplo</p>
                </div>
                <div className="d-flex gap-3 justify-content-center align-items-center mt-4">
                    ...
                    <p className="m-0">@forrajeriaesmoris</p>
                </div>
            </div>
        </div>
    </div>
